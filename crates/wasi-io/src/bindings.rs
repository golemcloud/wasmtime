wasmtime::component::bindgen!({
    ...
    imports: {
        ...
        "wasi:io/streams.[method]input-stream.read": async | trappable | tracing,
        "wasi:io/streams.[method]input-stream.skip": async | trappable | tracing,
        ...
        "wasi:io/streams.[method]output-stream.splice": async | trappable | tracing,
