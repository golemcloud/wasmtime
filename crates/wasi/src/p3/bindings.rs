...
mod generated {
    wasmtime::component::bindgen!({
        ...
        imports: {
            "wasi:clocks/system-clock.now": async | tracing | trappable,
            "wasi:clocks/system-clock.get-resolution": async | tracing | trappable,
            "wasi:clocks/monotonic-clock.now": async | tracing | trappable,
            "wasi:clocks/monotonic-clock.get-resolution": async | tracing | trappable,
            ...
            "wasi:filesystem/types.[method]descriptor.read-via-stream": store | async | tracing | trappable,
            "wasi:filesystem/types.[method]descriptor.write-via-stream": store | async | tracing | trappable,
            "wasi:filesystem/types.[method]descriptor.append-via-stream": store | async | tracing | trappable,
            "wasi:filesystem/types.[method]descriptor.read-directory": store | async | tracing | trappable,
            ...
            "wasi:sockets/types.[method]tcp-socket.send": store | async | tracing | trappable,
            "wasi:sockets/types.[method]tcp-socket.receive": store | async | tracing | trappable,
