...
//! module itself by default contains bindings for `async`-related traits.
//!
...
mod async_io {
    wasmtime::component::bindgen!({
        ...
        imports: {
            ...
            "wasi:filesystem/types.[method]descriptor.read-via-stream": async | tracing | trappable,
            ...
            "wasi:filesystem/types.[method]descriptor.write-via-stream": async | tracing | trappable,
            "wasi:filesystem/types.[method]descriptor.append-via-stream": async | tracing | trappable,
            ...
            "wasi:random/random.get-random-bytes": async | tracing | trappable,
            "wasi:random/random.get-random-u64": async | tracing | trappable,
            ...
            "wasi:random/insecure-seed.insecure-seed": async | tracing | trappable,
            "wasi:clocks/wall-clock.now": async | tracing | trappable,
            "wasi:clocks/wall-clock.resolution": async | tracing | trappable,
            "wasi:clocks/monotonic-clock.now": async | tracing | trappable,
            "wasi:clocks/monotonic-clock.resolution": async | tracing | trappable,
            "wasi:clocks/monotonic-clock.subscribe-instant": async | tracing | trappable,
            "wasi:clocks/monotonic-clock.subscribe-duration": async | tracing | trappable,
            "wasi:cli/environment.get-environment": async | tracing | trappable,
            "wasi:cli/environment.get-arguments": async | tracing | trappable,
            "wasi:cli/environment.initial-cwd": async | tracing | trappable,
            "wasi:filesystem/preopens.get-directories": async | tracing | trappable,
            "wasi:sockets/ip-name-lookup.resolve-addresses": async | tracing | trappable,
